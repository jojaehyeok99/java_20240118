...
public class B_Datatype {
	...
	public static void main(String[] args) {
		...
		long long1 = 2_147_483_648L; // 대문자 소문자 L 뒤에다가 넣기
		...
		// 소수점 6-7 자리에서 오차가 발생
		float float1 = 3.1415926535F; // 대문자, 소문자 f 둘다 가능
		...
		item = numbers[0]; // 초기화를 안해줬기 때문에 값은 0
		// System.out.println(item);
		numbers[0] = 99;
		// System.out.println(item);
		item = numbers[0];
		...
		// numbers : {99, 0, 0, 0, 0} x, [I@515f550a o
		// System.out.println(numbers);
		
		numbers2 = numbers; // 주소값이 복사되서 들어감
		// numbers2 : {99, 0, 0, 0, 0} x, [I@515f550a o
		// System.out.println(numbers2);
...
//		처음할당 할때 주소를 부여했으므로, 같은 주소를 가짐
		...
		// System.out.println(statement.equals("My nams is hulk")); //100% 동일한 것만 true
		// System.out.println(statement.compareTo("Apple")); //아스키코드
		...
		// 참조 데이터 타입
		// null : 아직 어떤한 값도 지정되지 않은 상태, 참조 데이터 타입의 기본값
		String string2 = null;
