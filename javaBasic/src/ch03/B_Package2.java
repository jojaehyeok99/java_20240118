...
public class B_Package2 {
	...
	public static void main(String[] args) {
		...
		//System.out.println(Math.round( 3.1415 * 100) / 100.0 ); // 소수점 세번째자리에서 반올림 하고 싶을 때 방법
		...
		// 범위 제약 
		//System.out.println(random.nextInt(45)); // : 0 ~ 44 안에 범위에서 랜덤으로 출력
		//System.out.println(random.nextInt() % 45 ); // -44 ~ 44 안에 범위에서 랜덤으로 출력
...
//			lotto.add(number);
//		} 
//		-> HashSet을 사용하면 정렬이 안됨
//		   Set을 사용하면 중복이 허용이 안되기 때문에 만약 숫자에 중복이 생기면 1개의 수만 뽑히는 경우 발생
		...
		// 연금복권 : 1~5조 0-9 중복허용한 6자리수 ex.5조588526
		...
		// Date 클래스의 대부분 메서드는JOK 1.1 부터 사용하지 않도록 권장하고 있음
		...
		// Date - > String
		// SimpleDateFormat 클래스를 사용하여 지정한 문자열으로 변경
