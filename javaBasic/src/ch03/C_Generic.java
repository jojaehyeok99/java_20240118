...
class Test5{
	...
	// 제너릭 메서드 : 해당 메서드의 매개변수 타입이나 반환 타입에서 사용할 타입을 외부에서 받아오려 할 때 사용
	// 제어자 <매개타입> 반환타입 메서드명 ( <매개타입> 매개변수 ) { ... }
...
public class C_Generic {
	...
	public static void main(String[] args) {
		...
		// -> 코드의 중복성	 
		 ...
		 myTest.subject = "국어";
		 myTest.score = 95; //Integer 타입
		 
		 Test3 yourTest = new Test3();
		 yourTest.subject = "경영학원론";
		 yourTest.score = "A+"; //String 타입
		 //myTest.score -> 여기서 사용하는 순간 오류 - 타입의 안정성이 떨어짐
		 
		 Test4<Integer> hisTest = new Test4<>();
		 hisTest.score = 95;
		 //hisTest.score = "A+" -> 타입이 불일치
		 
		 Test4<String> herTest = new Test4<>();
		 herTest.score = "A+";
		 
		 //herTest.score++; -> 타입이 불일치
		 hisTest.score++;
		// 여기 밑으로 집중 못함
		// Test5.method("object");
		// Test5.method(10);
