...
// 오버로드 : 같은 클래스 내에에서 동일한 메서드의 이름으로 여러개의 메서드를 정의할 수 있도록 하는 것
...
public class H_Polymorphism {
	...
	public static void main(String[] args) {
		...
		// 업캐스팅 :	하위클래스의 객체를 상위클래스의 참조변수에 담을 수 있도록 변환하는 것
		//		    인터페이스 구현 클래스를 구현한 인터페이스의 타입 참조 변수를 담을 수 있도록 하는 것
		Human1 human2 = new Developer1();  
		Human1 human3 = new FootballPlayer1(); 
		
		FootballPlay football = new FootballPlayer1();
		
		// human2.position = ""; 바라보고 있지 않음 <-이거 이해하기
		...
		//System.out.println(hm.goal); hm기준 FootballPlayer1 fp의 시야에
		//hm.kick
